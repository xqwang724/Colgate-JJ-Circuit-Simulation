...
def ColgateJJSim(circuit_name, simulation_length):
    # Constants

    Phi0 = 2.067833848e-15

    my_circuit = read_cir.cir_to_networkx(circuit_name)
    ...
    print("--- solve ode time: %s seconds ---" % (time.time() - start_time))
    ...
    print("--- post simulation time %s seconds ---" % (time.time() - start_time))
...
if __name__ == "__main__":
    ...
    # Simulation function
    ColgateJJSim("singleneuron_mod.cir",0.1e-9)
    # ColgateJJSim("singlejunction_IV.cir",0.1e-9)
